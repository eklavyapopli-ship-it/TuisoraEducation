...
const ReviewCards = () => {
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto h-fit pb-20 mt-20">
            ...
            <div className=" mt-20 lg:grid lg:grid-cols-2 gap-x-10 gap-y-10  place-items-center flex flex-col">
                {displayedData.map((item) => (
                    ...
                    whileHover={{scale:1.05}}
                     key={item._id} className={`h-60 p-10 md:w-150 w-fit border-black rounded-2xl flex flex-col relative shadow-md text-black ${josefin.className}`}>
