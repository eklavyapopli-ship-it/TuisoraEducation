...
const OfferCards = () => {
  return (
    <section className='w-screen h-fit'>
      ...
      <div className='w-full h-fit grid justify-center lg:space-y-0 space-y-5  mt-15 lg:space-x-8  space-x-0 lg:mt-20 lg:grid-cols-3 grid-cols-1 lg:place-content-center place-items-center'>
        {OfferHeads.map((item)=>(
